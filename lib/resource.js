...
const addPath = function (path, method, schema) {
  if (!this.docs) return
  if (!this.docs.paths[path]) this.docs.paths[path] = {}
  if (!this.docs.paths[path][method]) {
    const hasId = /{id}/.test(path)
    const name = path.split('/')[1]
    this.docs.paths[path][method] = swagger.skeleton(name, schema)[String(hasId)][method]
  }
}
...
class Resource {
  ...
  list (options) {
    ...
    addPath.call(this.rester, `/${this.path}`, 'get', this.model.swaggerSchema)
    return this
  }
  /**
  ...
  get (options) {
    ...
    addPath.call(this.rester, `/${this.path}/{id}`, 'get', this.model.swaggerSchema)
    return this
  }
  /**
  ...
  post (options) {
    ...
    addPath.call(this.rester, `/${this.path}`, 'post', this.model.swaggerSchema)
    return this
  }
  /**
  ...
  patch (options) {
    ...
    addPath.call(this.rester, `/${this.path}/{id}`, 'patch', this.model.swaggerSchema)
    return this
  }
  /**
  ...
  put (options) {
    ...
    addPath.call(this.rester, `/${this.path}/{id}`, 'put', this.model.swaggerSchema)
    return this
  }
  /**
  ...
  delete (options) {
    ...
    addPath.call(this.rester, `/${this.path}/{id}`, 'delete', this.model.swaggerSchema)
    return this
  }
  use (fn) {
