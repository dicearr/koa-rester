...
class Rester {
  ...
  constructor(options = {}) {
    ...
    if (this.router === undefined) throw new Error('Undefined router');
   ...
   * @param {Function} options.before - beforeList, beforePost, beforeGet,
   * beforePut and/or beforeDelte: A koa middleware to be executed before the selected operation.
   * @param {Function} options.after - afterList, afterPost, afterGet,
   * afterPut and/or afterDelte: A koa middleware to be executed after the selected operation.
  ...
  rest(options = {}) {
    ['list', 'post', 'get', 'patch', 'delete'].forEach((m) => {
      ...
      if (before !== undefined) specificOpts.before = before;
      const after = options[`after${m[0].toUpperCase()}${m.slice(1)}`];
      if (after !== undefined) specificOpts.after = after;
  ...
  list(options = {}) {
    ...
    if (options.before !== undefined) {
      r.get(`/${this.base}`, options.before);
    }
  ...
  post(options = {}) {
    ...
    const r = this.router;
    if (options.before !== undefined) {
      r.post(`/${this.base}`, options.before);
    }
    ...
    if (options.after !== undefined) {
      r.post(`/${this.base}`, options.after);
    }
    return this;
  }
  /**
  ...
  get(options = {}) {
    ...
    const r = this.router;
    if (options.before !== undefined) {
      r.get(`/${this.base}/:id`, options.before);
    }
    ...
    if (options.after !== undefined) {
      r.get(`/${this.base}/:id`, options.after);
    }
    return this;
  }
  /**
  ...
  patch(options = {}) {
    ...
    const r = this.router;
    if (options.before !== undefined) {
      r.patch(`/${this.base}/:id`, options.before);
    }
    ...
    if (options.after !== undefined) {
      r.patch(`/${this.base}/:id`, options.after);
    }
    return this;
  }
  /**
  ...
  delete(options = {}) {
    ...
    const r = this.router;
    if (options.before !== undefined) {
      r.delete(`/${this.base}/:id`, options.before);
    }
    ...
    if (options.after !== undefined) {
      r.delete(`/${this.base}/:id`, options.after);
    }
    return this;
  }
  /**
